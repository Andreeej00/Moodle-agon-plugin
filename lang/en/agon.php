...
$string['hintalreadyused'] = 'You have already used your one hint for this attempt.';
$string['invalidgamejson'] = 'This must be valid JSON containing a complete "{$a}" list (a question\'s "correct" must point at an option; every coding ____ needs a matching blank answer that is also offered as an option).';

...
/**
 * Web service: finish the current user's attempt.
 *
 * @package     mod_agon
...
class finish_attempt extends external_api {
    ...
    /**
     * Finish the attempt and return its final summary.
     *
    ...
    public static function execute(int $cmid): array {
        ...
        $cm = self::setup_play_context($cmid);
        $attempt = attempt::start($cm->instance, $USER->id);
        $attempt = attempt::finish($attempt);
        return attempt::summary($attempt);
    }
